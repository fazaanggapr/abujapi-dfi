      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-8">
          ...
          <div className="flex items-center justify-between p-6">
            <div className="flex items-center space-x-4">
              <button
                ...
                className="group flex items-center space-x-3 px-4 py-2 rounded-xl bg-gradient-to-r from-blue-600 to-indigo-600 text-white hover:from-blue-700 hover:to-indigo-700 transition-all duration-200 shadow-lg hover:shadow-xl"
              >
        ...
        <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-lg border border-white/20 p-6 mb-8">
          <div className="flex items-center space-x-4">
            ...
            <div>
              <h1 className="text-2xl font-bold text-slate-800">Laporan Patroli</h1>
              ...
              <div className="p-6 space-y-4">
                <div className="flex items-start space-x-4 p-4 bg-gradient-to-r from-emerald-50 to-green-50 rounded-xl border border-emerald-200">
                  ...
                  <div className="flex-1">
                    <p className="text-slate-700 font-medium">Pemeriksaan Fasilitas Toilet</p>
                    <p className="text-sm text-slate-600 mt-1">
                      Memeriksa kondisi toilet pria, mencatat kerusakan pada keran air dan fasilitas lainnya
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4 p-4 bg-gradient-to-r from-amber-50 to-orange-50 rounded-xl border border-amber-200">
                  ...
                  <div className="flex-1">
                    <p className="text-slate-700 font-medium">Inspeksi Sistem Pencahayaan</p>
                    <p className="text-sm text-slate-600 mt-1">
                      Memeriksa kondisi lampu di setiap lantai dan melaporkan yang perlu diperbaiki
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-lg border border-white/20 overflow-hidden">
              ...
              <div className="p-6">
                <div className="flex items-center space-x-3 mb-6 p-4 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-xl">
                  ...
                  <div>
                    <p className="font-semibold text-slate-800">Mall Ciputra Japan</p>
                  ...
                  <div className="flex items-center justify-between mb-4">
                    ...
                    <div className="flex-1 mx-4">
                      ...
                      <div className="text-center">
                        <div className={`inline-flex items-center justify-center w-16 h-16 ${locations[currentLocation].color} rounded-2xl mb-3 shadow-lg`}>
                          <MapPin className="w-8 h-8 text-white" />
                        </div>
                        <p className="font-semibold text-slate-800">{locations[currentLocation].name}</p>
                        <p className="text-sm text-slate-600 capitalize">{locations[currentLocation].status}</p>
                      </div>
                    </div>
              ...
              <div className="p-6 space-y-4">
                ...
                <div className="bg-gradient-to-br from-white to-slate-50 rounded-xl p-5 shadow-md border border-slate-200">
                  <div className="flex items-center space-x-3 mb-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-slate-600">Dokumentasi Lapangan</p>
                    </div>
                  </div>
                  
                  <div className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-lg p-4 mb-4">
                    <p className="text-slate-700 font-medium">Periksa keran toilet pria</p>
                    <p className="text-sm text-slate-600 mt-1">Kondisi keran air perlu perhatian khusus</p>
                  </div>
                  
                  <button
                    onClick={() => handleViewImage("19:47", "Periksa keran toilet pria")}
                ...
                <div className="bg-gradient-to-br from-white to-slate-50 rounded-xl p-5 shadow-md border border-slate-200">
                  ...
                  <div className="bg-gradient-to-r from-amber-50 to-orange-50 rounded-lg p-4 mb-4">
                    <p className="text-slate-700 font-medium">Pemeriksaan lampu lantai 2</p>
                    <p className="text-sm text-slate-600 mt-1">Status pencahayaan dalam kondisi baik</p>
                  </div>
                  
                  <button
                    onClick={() => handleViewImage("20:15", "Pemeriksaan lampu lantai 2")}
