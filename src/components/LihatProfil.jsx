...
import { User, ArrowLeft, Phone, Mail, MapPin } from "lucide-react";
...
const EmployeeDetail = () => {
  const [employee] = useState({
    ...
    address: 'Perumahan Isekai, Jl. Mandiri RT 02/RW 05, No. 666, Kab. No.646, Cibinong, Sukahati',
    gender: 'Lelaki',
    age: '30 tahun',
    height: '200 cm',
    weight: '71 kg',
            ...
            <div className="bg-white rounded-lg shadow-md p-6 mb-6 border border-gray-200">
              <div className="flex flex-col md:flex-row gap-6">
                ...
                <div className="flex-shrink-0">
                  <div className="w-32 h-40 bg-blue-800 rounded-lg overflow-hidden relative flex items-center justify-center">
    ...
    />
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
              ...
              <div className="bg-gradient-to-r from-blue-900 to-blue-800 rounded-lg p-4">
                <h3 className="text-white font-semibold mb-4 text-center">Riwayat Kerja</h3>
                <div className="space-y-3">
                  {workHistory.map((work, index) => (
                    <div key={index} className="flex items-center space-x-3">
                      ...
                      <div className="text-white text-sm">
                        ...
                        <div className="text-white/60 text-xs">{work.period}</div>
                      </div>
                    </div>
                  ))}
                </div>
              ...
              {/* Skills */}
              <div className="bg-gradient-to-r from-blue-900 to-blue-800 rounded-lg p-4">
                <h3 className="text-white font-semibold mb-4 text-center">Keahlian</h3>
                <div className="space-y-3">
                  {skills.map((skill, index) => (
                    <div key={index} className="flex items-center space-x-3">
                      ...
                      <div className="text-white text-sm">
                        ...
                        <div className="text-white/80 text-xs">{skill.description}</div>
                      </div>
                    </div>
                  ))}
                </div>
            ...
            <div className="bg-gradient-to-r from-blue-900 to-blue-800 rounded-lg p-4 mb-6">
              <h3 className="text-white font-semibold mb-4 text-center">Sertifikasi</h3>
              <div className="flex justify-between items-center">
                {certifications.map((cert, index) => (
                  <React.Fragment key={index}>
                    <div className="text-white text-center flex-1">
                      <div className="w-4 h-4 bg-orange-400 rounded-full mx-auto mb-1"></div>
                      <div className="text-xs">{cert.name}<br/>{cert.year}</div>
                    </div>
          ...
          <div className="lg:col-span-1">
            ...
            <div className="bg-white rounded-b-lg shadow-md p-6 space-y-4 border border-gray-200 border-t-0">
              <div>
                <label className="block text-sm font-medium text-gray-600 mb-1">Status Karyawan</label>
                <div className="px-3 py-2 bg-green-50 border border-green-200 rounded-md">
                  <span className="text-green-800 font-medium">{employee.employeeStatus}</span>
                </div>
              </div>
              ...
              <div>
                <label className="block text-sm font-medium text-gray-600 mb-1">Lama Bekerja</label>
                <div className="px-3 py-2 bg-gray-50 border border-gray-200 rounded-md text-gray-800">
              ...
              <div>
                <label className="block text-sm font-medium text-gray-600 mb-1">Lokasi Penempatan</label>
                <div className="px-3 py-2 bg-gray-50 border border-gray-200 rounded-md text-gray-800">
                  {employee.location}
                </div>
              </div>
            ...
            <div className="mt-6 flex space-x-4">
              <button 
                ...
                className="flex-1 bg-orange-600 hover:bg-orange-700 text-white font-bold py-3 px-6 rounded-lg transition duration-200 shadow-md transform hover:-translate-y-1"
              >
                EDIT DATA
              </button>
              <button 
