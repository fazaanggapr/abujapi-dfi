    ...
    <div className="bg-white/95 backdrop-blur-sm p-12 rounded-2xl shadow-2xl w-[90%] max-w-[450px] m-3 border border-white/20">
      ...
      <form onSubmit={onSubmit} className="space-y-5">
        ...
        {loading ? (
          ...
          <button
            type="submit"
            className="w-full py-4 bg-gradient-to-r from-yellow-400 to-yellow-500 text-gray-900 border-none rounded-lg text-base font-bold cursor-pointer hover:from-yellow-500 hover:to-yellow-600 transition-all duration-200 shadow-lg mt-6"
          >
            Register
          </button>
        )}
